...
Deno.serve(async (req) => {
    ...
    const bucketConfig = {
        id: 'imagenes-lugares',
        name: 'imagenes-lugares',
        public: true
    };

    // Add optional configurations
    bucketConfig.allowed_mime_types = ["image/jpeg", "image/png", "image/heic", "image/webp"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for imagenes-lugares" ON storage.objects FOR SELECT USING (bucket_id = 'imagenes-lugares');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for imagenes-lugares" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'imagenes-lugares');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for imagenes-lugares" ON storage.objects FOR UPDATE USING (bucket_id = 'imagenes-lugares');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for imagenes-lugares" ON storage.objects FOR DELETE USING (bucket_id = 'imagenes-lugares');`
    ];
