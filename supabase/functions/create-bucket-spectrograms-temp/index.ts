...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/png", "image/jpeg", "image/jpg"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for spectrograms" ON storage.objects FOR SELECT USING (bucket_id = 'spectrograms');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for spectrograms" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'spectrograms');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for spectrograms" ON storage.objects FOR UPDATE USING (bucket_id = 'spectrograms');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for spectrograms" ON storage.objects FOR DELETE USING (bucket_id = 'spectrograms');`
    ];
